        ...
        if "com" in args.output_types:
            ...
            Thread(
                ...
                args=(
                    com,
                    filename.replace(
                        args.images_src, os.path.join(args.output_dir, "com")
                    ).replace(".jpg", ".png"),
                ),
            ).start()
        if "pha" in args.output_types:
            Thread(
                ...
                args=(
                    pha,
                    filename.replace(
                        args.images_src, os.path.join(args.output_dir, "pha")
                    ).replace(".png", ".jpg"),
                ),
            ).start()
        if "fgr" in args.output_types:
            Thread(
                ...
                args=(
                    fgr,
                    filename.replace(
                        args.images_src, os.path.join(args.output_dir, "fgr")
                    ).replace(".png", ".jpg"),
                ),
            ).start()
        if "err" in args.output_types:
            ...
            Thread(
                ...
                args=(
                    err,
                    filename.replace(
                        args.images_src, os.path.join(args.output_dir, "err")
                    ).replace(".png", ".jpg"),
                ),
            ).start()
        if "ref" in args.output_types:
            ...
            Thread(
                ...
                args=(
                    ref,
                    filename.replace(
                        args.images_src, os.path.join(args.output_dir, "ref")
                    ).replace(".png", ".jpg"),
                ),
            ).start()
